...
define('text_menu_title', '菜单');
define('text_menu_home', '首页');
define('text_menu_search', '搜索');
define('text_menu_downloads', '下载');
define('text_menu_blacklist', '黑名单');
define('text_menu_guilds', '公会');
define('text_menu_statistics', '统计');
define('text_menu_conected', '在线玩家');
define('text_menu_gamemasters', '管理员');
...
//Module Ranking
define('text_title_ranking_name', '玩家等级排行榜');
...
define('text_guild_messages', '消息');
define('text_guild_view_messages', '查看留言');
define('text_guild_score', 'Score');
define('text_guild_level', 'Level');
define('text_guild_role', 'Role');

define('text_guilds_ranking_name', '公会排名');
define('text_guilds_badge', '徽章');
define('text_guilds_name', 'Name');
define('text_guilds_experience', '经验');
...
define('text_blacklist_privileges', 'PrivilePrivilegesgios');
define('text_ranking_trophies', 'Trophies');
define('text_blacklist_ranking_name', '黑名单排行');
...
define('text_gamemaster_letestupdate', '最新更新');

//Module GameMasters
define('text_statistics_status', '状态');
define('text_statistics_name_of_server', '服务器');
define('text_statistics_status_server', '状态');
define('text_statistics_title', '统计');

//Module GameMasters
define('text_playersonline_online_title', '在线玩家');
define('text_playersonline_lague', 'League');
define('text_playersonline_level', 'Level');
define('text_playersonline_name', 'Name');
define('text_playersonline_experience', '经验');
define('text_playersonline_status', '状态');
define('text_playersonline_accountprivileges', 'Privileges');
define('text_playersonline_gems', '宝石');
define('text_playersonline_trophies', 'Trophies');
define('text_playersonline_status_title', '状态');
